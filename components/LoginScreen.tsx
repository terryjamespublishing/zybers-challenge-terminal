    ...
    <div className="flex flex-col h-full px-6 py-8">
      <div className="w-full max-w-5xl flex-grow flex flex-col">
        <div className="mb-6 opacity-80">
          <div className="text-2xl md:text-4xl opacity-60 mb-2">ZYBER SYSTEMS NETWORK v1.0</div>
          <div className="text-xl md:text-2xl opacity-60">Copyright (C) 1985 Zyber Corp.</div>
        </div>
        ...
        <div className="flex-grow overflow-y-auto mb-4 text-2xl md:text-4xl space-y-2">
        ...
        {showInput && (
          <form onSubmit={handleSubmit} className="mt-auto">
            <div className="flex items-center cursor-text border-t border-primary/30 pt-3" onClick={focusInput}>
              <span className="mr-2 opacity-50 text-2xl md:text-4xl">&gt;</span>
              <span className="text-2xl md:text-4xl">{input}</span>
              <span className="animate-blink text-2xl md:text-4xl">▋</span>
              <input
                ref={inputRef}
                type="text"
                value={input}
